  ...
  contact@supernpro.com
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><Link href="/automobile" className="hover:text-white">Automobile</Link></li>
            <li><Link href="real-estate" className="hover:text-white">Real Estate</Link></li>
            <li><Link href="fashion-lifestyle" className="hover:text-white">Fashion & Lifestyle</Link></li>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://www.instagram.com/supernproinfo/?next=%2F" className="hover:text-gray-300"><FaInstagram size={24} /></a>
          </div>
        </div>
      </div>
