    ...
    <div className=" mx-auto p-4 flex flex-col md:flex-row gap-6">
      ...
      <div className=" w-full md:w-3/5 shadow-md p-4 order-1 md:order-2 h-[150vh]  overflow-y-auto scrollbar-hide">
        ...
        />
         ...
         <AnimatedLink text={"India's BEST RuPay Card Get 1.5% BACK on UPI, ZERO JOINING FEE Apply Now"} link="https://spectrum.gotrackier.com/click?campaign_id=1201&pub_id=945&source=%7B2%7D"/>
